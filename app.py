...
if selected == 'Diabetes Prediction':  # pagetitle
    ...
    st.image(image, caption='diabetes disease prediction', width = 500)
    # columns
...
if selected == 'Parkinson Prediction':
    ...
    st.image(image, caption='parkinsons disease', width = 500)
  # parameters
...
if selected == 'Lung Cancer Prediction':
    ...
    st.image(image, caption='Lung Cancer Prediction', width = 500)
